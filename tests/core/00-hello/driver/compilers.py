...
class Compiler:
    ...
    def execute_compiler_pre(self, cmd):
        """Executes the cmopilation command cmd, as a nobody user in some tmp directory."""
        cwd = os.getcwd()
        tmp = "/tmp/compilation." + str(uuid.uuid4())[:8]
        shutil.copytree(cwd, tmp)
        os.chdir(tmp)
        logging.info("compiling under " + tmp)
        try:
            self.execute_compiler2(cmd)
            shutil.rmtree(cwd)
            shutil.copytree(tmp, cwd)
        finally:
            os.chdir(cwd)
            shutil.rmtree(tmp)
    ...
    def execute_monitor(self, tst, pgm):
        ...
        # Prepare the command
        cmd = "%s --basename=%s --maxtime=%i %s %s" % (monitor.path, tst, maxtime, ops, pgm)
...
class Compiler_GenericC(Compiler):
    ...
    def compile_normal(self):
        ...
        try:
            self.execute_compiler(f"{self.cmd()} {self.flags1()} program.c -o program.exe -lm 2> compilation1.txt")
    ...
    def compile_no_main(self):
        ...
        try:
            self.execute_compiler(f"{self.cmd()} -c {self.flags1()} program.c 2> compilation1.txt")
        except CompilationTooLong:
            util.write_file("compilation1.txt", "Compilation time exceeded")
            util.del_file("program.o")
            return False
        ...
        util.del_file("program.exe")
        try:
            self.execute_compiler(f"{self.cmd()} {self.flags2()} program.c -o program.exe -lm 2> compilation2.txt")
        except CompilationTooLong:
            util.write_file("compilation1.txt", "Compilation time exceeded")
            util.del_file("program.exe")
            return False
...
class Compiler_GenericCXX(Compiler):
    ...
    def compile_normal(self):
        ...
        util.del_file("program.exe")
        try:
            self.execute_compiler(f"{self.cmd()} {self.flags1()} program.cc -o program.exe 2> compilation1.txt")
        except CompilationTooLong:
            util.write_file("compilation1.txt", "Compilation time exceeded")
            util.del_file("program.exe")
            return False
        ...
        util.del_file("program.exe")
        try:
            self.execute_compiler(f"{self.cmd()} {self.flags2()} program.cc -o program.exe 2> compilation2.txt")
        except CompilationTooLong:
            util.write_file("compilation1.txt", "Compilation time exceeded")
            util.del_file("program.exe")
            return False
    ...
    def compile_no_main(self):
        ...
        util.del_file("program.o")
        try:
            self.execute_compiler(f"{self.cmd()} -c {self.flags1()} program.cc 2> compilation1.txt")
        except CompilationTooLong:
            util.write_file("compilation1.txt", "Compilation time exceeded")
            util.del_file("program.o")
            return False
...
class Compiler_GFortran(Compiler):
    ...
    def compile(self):
        ...
        try:
            self.execute_compiler(
                "gfortran " + self.flags1() + " program.f -o program.exe 1> /dev/null 2> compilation1.txt"
            )
        except CompilationTooLong:
            util.write_file("compilation1.txt", "Compilation time exceeded")
            util.del_file("program.exe")
...
class Compiler_GHC(Compiler):
    ...
    def compile_normal(self):
        ...
        try:
            self.execute_compiler(
                "ghc " + self.flags1() + " program.hs -o program.exe 1> /dev/null 2> compilation1.txt"
            )
        except CompilationTooLong:
            util.write_file("compilation1.txt", "Compilation time exceeded")
            util.del_file("program.exe")
...
class Compiler_RunHaskell(Compiler):
    ...
    def compile_with(self, extra):
        try:
            ...
            f.close()
            self.execute_compiler(
                "ghc  -main-is mainjutgeorg " + self.flags1() + " work.hs -o work.exe 1> /dev/null 2> compilation1.txt"
            )
        except CompilationTooLong:
            util.write_file("compilation1.txt", "Compilation time exceeded")
            return False
...
class Compiler_RunPython(Compiler):
    ...
    def compile(self):
        ...
        try:
            self.execute_compiler("python3 -m py_compile program.py 1> /dev/null 2> compilation1.txt")
        except CompilationTooLong:
            util.write_file("compilation1.txt", "Compilation time exceeded")
            return False
...
class Compiler_GNAT(Compiler):
    ...
    def compile(self):
        ...
        try:
            self.execute_compiler(
                "gnat make " + self.flags1() + " program.ada -o program.exe 1> /dev/null 2> compilation1.txt"
            )
        except CompilationTooLong:
            util.write_file("compilation1.txt", "Compilation time exceeded")
            util.del_file("program.exe")
...
class Compiler_JDK(Compiler):
    ...
    def execute(self, tst):
        ...
        # Prepare the command
        cls = "JudgeMain"
        cmd = "%s --basename=%s --maxtime=10 %s %s -- /usr/bin/java %s %s" % (monitor.path, tst, ops, opsX, opsJ, cls)
...
class Compiler_Python3(Compiler):
    ...
    def compile_no_main(self):
        ...
        try:
            self.execute_compiler("python3 -m py_compile program.py 1> /dev/null 2> compilation2.txt")
        except CompilationTooLong:
            util.write_file("compilation1.txt", "Compilation time exceeded")
            return False
...
class Compiler_Codon(Compiler):
    ...
    def compile_no_main(self):
        ...
        util.del_file("compilation1.txt")
        try:
            self.execute_compiler("python3 -m py_compile program.codon 1> /dev/null 2> compilation1.txt")
        except CompilationTooLong:
            util.write_file("compilation1.txt", "Compilation time exceeded")
            return False
        if util.file_size("compilation1.txt") != 0:
...
class Compiler_nodejs(Compiler):
    ...
    def execute(self, tst):
        ...
        cmd = "%s --basename=%s --maxprocs=100 --maxmem=1024:1024 -- /usr/bin/node program.js" % (monitor.path, tst)
...
class Compiler_Verilog(Compiler):
    ...
    def compile(self):
        ...
        self.execute_compiler(
            "/usr/local/bin/iverilog-0.8 -o program.vvp " + self.flags1() + " program.v 2> compilation1.txt"
        )
    ...
    def compile(self):
        ...
        try:
            ...
            self.execute_compiler(
                ...
                "g++ "
                + self.flags1()
                + " *.cc -o ../program.exe 2> ../compilation1.txt"
            )
        except CompilationTooLong:
            os.chdir("..")
            util.write_file("compilation1.txt", "Compilation time exceeded")
        ...
        try:
            ...
            self.execute_compiler("g++ " + self.flags2() + " *.cc -o ../program.exe 2> ../compilation2.txt")
        except CompilationTooLong:
            os.chdir("..")
            util.write_file("compilation1.txt", "Compilation time exceeded")
            util.del_file("program.exe")
...
class Compiler_MakePRO2(Compiler):
    ...
    def compile(self):
        ...
        try:
            ...
            self.execute_compiler("make program.exe 1> make.log 2> compilation1.txt")
        except CompilationTooLong:
            util.write_file("../compilation1.txt", "Compilation time exceeded")
            os.chdir("..")
            return False
...
class Compiler_Rust(Compiler):
    ...
    def compile(self):
        util.del_file("program.exe")
        try:
            self.execute_compiler("rustc -o program.exe " + self.flags1() + " program.rs 2> compilation1.txt")
        except CompilationTooLong:
            util.write_file("compilation1.txt", "Compilation time exceeded")
            util.del_file("program.exe")
            return False
...
class Compiler_Crystal(Compiler):
    ...
    def compile(self):
        util.del_file("program.exe")
        try:
            self.execute_compiler("crystal build -o program.exe " + self.flags1() + " program.cr 2> compilation1.txt")
        except CompilationTooLong:
            util.write_file("compilation1.txt", "Compilation time exceeded")
            util.del_file("program.exe")
            return False
...
class Compiler_Nim(Compiler):
    ...
    def compile(self):
        ...
        try:
            self.execute_compiler(
                "nim c -o:program.exe " + self.flags1() + " program.nim 1> /dev/null 2> compilation1.txt"
            )
        except CompilationTooLong:
            util.write_file("compilation1.txt", "Compilation time exceeded")
            util.del_file("program.exe")
...
class Compiler_Julia(Compiler):
    ...
    def compile(self):
        util.del_file("program.exe")
        try:
            self.execute_compiler("julia " + self.flags1() + " program.jl 1> /dev/null 2> compilation1.txt")
        except CompilationTooLong:
            util.write_file("compilation1.txt", "Compilation time exceeded")
            util.del_file("program.exe")
            return False
...
class Compiler_Kotlin(Compiler):
    ...
    def compile(self):
        util.del_file("program.exe")
        try:
            self.execute_compiler("kotlinc " + self.flags1() + " program.kt")
        except CompilationTooLong:
            util.write_file("compilation1.txt", "Compilation time exceeded")
            util.del_file("program.exe")
            return False
