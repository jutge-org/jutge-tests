...
export const createNoMainTar = async (
	dir: string,
	testDir: string,
	language: string,
	programFile: string
...
export const noMainTestForLanguage = (dir: string) => {
	...
	test.concurrent.each(testCases)(
		...
		async (programFile, programPath, expectedVerdict) => {
			...
			await createNoMainTar(dir, testDir, language, programPath)
