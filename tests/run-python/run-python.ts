...
export const createRunPythonTar = async (
	dir: string,
	testDir: string,
	language: string,
	programFile: string
...
export const runPythonTestForLanguage = (dir: string) => {
	...
	test.concurrent.each(testCases)(
		...
		async (programFile, programPath, expectedVerdict) => {
			...
			await createRunPythonTar(dir, testDir, language, programPath)
