...
export const createRunHaskellTar = async (
	dir: string,
	testDir: string,
	language: string,
	programFile: string
...
export const runHaskellTestForLanguage = (dir: string) => {
	...
	test.concurrent.each(testCases)(
		...
		async (programFile, programPath, expectedVerdict) => {
			...
			await createRunHaskellTar(dir, testDir, language, programPath)
