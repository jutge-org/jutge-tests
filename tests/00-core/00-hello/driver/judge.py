...
class Judge:
        ...
        for test in self.tests:
            ...
            if "execution" not in inf:
                ...
                if checker == "std":
                    ...
                    ver = checkers.double_elastic(
                        out, cor, separator1, separator2, starting, ending, presentation_error
                    )
    ...
    def get_tests(self):
        ...
        tests = [
            t.replace(".inp", "").replace(self.dir + "/problem/", "") for t in glob.glob(self.dir + "/problem/*.inp")
        ]
