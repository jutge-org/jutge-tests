...
export const createGraphicsTar = async (
	dir: string,
	testDir: string,
	language: string,
	programFile: string
...
export const GraphicsTestForLanguage = (dir: string) => {
	...
	test.concurrent.each(testCases)(
		...
		async (programFile, programPath, expectedVerdict) => {
			...
			await createGraphicsTar(dir, testDir, language, programPath)
