...
export const createRunClojureTar = async (
	dir: string,
	testDir: string,
	language: string,
	programFile: string
...
export const runClojureTestForLanguage = (dir: string) => {
	...
	test.concurrent.each(testCases)(
		...
		async (programFile, programPath, expectedVerdict) => {
			...
			await createRunClojureTar(dir, testDir, language, programPath)
