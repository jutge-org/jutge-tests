...
export const createSumaDosTar = async (
	dir: string,
	testDir: string,
	language: string,
	programFile: string
...
export const sumaDosTestForLanguage = (dir: string) => {
	...
	test.concurrent.each(testCases)(
		...
		async (programFile, programPath, expectedVerdict) => {
			...
			await createSumaDosTar(dir, testDir, language, programPath)
