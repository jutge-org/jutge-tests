...
export const createCircuitsTar = async (
	dir: string,
	testDir: string,
	language: string,
	programFile: string
...
export const runCircuitsTestForLanguage = (dir: string) => {
	...
	test.concurrent.each(testCases)(
		...
		async (programFile, programPath, expectedVerdict) => {
			...
			await createCircuitsTar(dir, testDir, language, programPath)
...
export const doRunCircuitsTest = (dir: string) => {
	beforeAll(createDriverAndProblem(dir))
	afterAll(removeDriverAndProblem(dir))
	runCircuitsTestForLanguage(dir)
}
